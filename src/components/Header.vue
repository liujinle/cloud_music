    ...
    <div class="header_left">
      ...
      <div class="search">
        <div class="search_history">
          ...
          <div class="icons">
            <Svgicon
              iconClass="icon-qianjin1"
              :iconStyle="colorChange.color2"
            />
          </div>
        </div>
        ...
        <div class="search_box">
          <div class="search_box_container">
            <div class="search_box_icon">
              <Svgicon iconClass="icon-sousuo" iconStyle="color:#f9d8d8" />
            </div>
      ...
      <div class="setting">
        <div class="setting_con">
          <div class="setting_customer">
            ...
            <div class="setting_customer_islogin">
              <span>{{ "未登录" }}</span>
            </div>
...
let isFocus = ref<boolean>(true);
let search_val = ref<string>("");
    ...
    .setting {
      ...
      .setting_con {
        ...
        .setting_customer {
          ...
          justify-content: center;
          align-items: center;
          .setting_customer_img {
            width: 25px;
            height: 25px;
          }
          .setting_customer_islogin {
            margin: 0 6px;
            font-size: 12px;
            color: $white;
            position: relative;
